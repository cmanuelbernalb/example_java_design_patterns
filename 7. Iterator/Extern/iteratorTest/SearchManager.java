...
public class SearchManager extends JFrame {
	...
	public SearchManager() throws Exception {
		...
		// Create Labels
		JLabel lblCertificationType = new JLabel("Certification Type:");
		JLabel lblSelectedCandidates = new JLabel("Results:");

		// Create the open button
		JButton btnGetSelectedCandidates = new JButton(SearchManager.GET_CANDIDATES);
...
class buttonHandler implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals(SearchManager.GET_CANDIDATES)) {
			...
			Iterator certCandidates = ac.getCertifiedCandidates(selection);
